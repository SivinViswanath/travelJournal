    ...
    <nav className="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-black/20 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link href={user ? '/dashboard' : '/'} className="flex items-center space-x-2 group relative z-50">
             ...
             {user ? (
               <>
                 <div className="flex flex-col items-center space-y-2">
                    ...
                    <span className="text-lg font-medium text-cyan-100">{user.name || user.email}</span>
                 </div>
