        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24 relative z-10">
          <div className="flex-1 text-center lg:text-left">
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl text-slate-400 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed"
            >
              Document your inter-city or international adventures with a
              platform designed for the modern explorer. Capture, rate, and
            ...
            >
              <Link
                ...
                className="group relative px-8 py-4 rounded-full bg-cyan-600 hover:bg-cyan-500 transition-all duration-300 shadow-[0_0_40px_-10px_rgba(8,145,178,0.5)] hover:shadow-[0_0_60px_-10px_rgba(8,145,178,0.7)]"
              >
                <span className="flex items-center gap-2 text-lg font-bold text-white">
                  {user ? 'Explore Your Journey' : 'Start Your Journey'}{' '}
          ...
          >
            <div className="relative w-full aspect-square mx-auto">
              <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/20 to-purple-500/20 rounded-full blur-3xl -z-10" />
        ...
        >
          <GlassCard className="p-8 group">
            ...
            <p className="text-slate-400 leading-relaxed">
              Pinpoint every stop on your itinerary with precision mapping and
              detailed logs.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-8 group">
            ...
            <p className="text-slate-400 leading-relaxed">
              Store high-resolution snapshots of your favorite moments directly
              in your journal.
            </p>
          </GlassCard>
          ...
          <GlassCard className="p-8 group">
            ...
            <p className="text-slate-400 leading-relaxed">
              Curate your own travel guide by rating places, hotels, and
              restaurants.
            </p>
          </GlassCard>

          <GlassCard
            className="p-8 group sm:col-span-2 lg:col-span-3 lg:w-2/3 lg:mx-auto cursor-pointer hover:bg-white/5 transition-all relative overflow-hidden"
            onClick={handleFindNearbyPlaces}
            enableTilt={true}
          >
            {/* Scanning Laser Effect */}
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-scan pointer-events-none z-20" />
            ...
            <div
              className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left relative z-10"
              style={{ transform: 'translateZ(20px)' }}
            >
              <div
                className={`bg-gradient-to-br from-emerald-500/20 to-teal-500/20 w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 border border-white/10 group-hover:scale-110 transition-transform duration-300 ${isLoading ? 'animate-pulse' : ''}`}
              >
                <Compass
                  className={`w-8 h-8 text-emerald-400 ${isLoading ? 'animate-spin' : ''}`}
                />
              </div>
              <div>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {suggestions.map((place, index) => (
                <GlassCard
                  key={index}
                  className="p-6 flex flex-col h-full border-t-4 border-t-emerald-500/50"
                >
        ...
        <div className="mt-32 relative">
          <GlassCard className="p-12 text-center relative overflow-hidden">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-xl mx-auto relative z-10">
              Join thousands of digital nomads and travelers documenting their
