...
export default function NewTripPage() {
  ...
  const handleImageUpload = async (files: File[]) => {
    ...
    toast.success(`${files.length} image(s) ready to upload`);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create trip first
      const { data } = await api.post('/trip', formData);
      ...
      if (uploadedImages.length > 0) {
        ...
        await api.post(`/trip/${tripId}/images`, imageFormData, {
          headers: {
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 glass border border-white/20 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm sm:text-base text-white placeholder-gray-400"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={6}
                className="w-full px-4 py-3 glass border border-white/20 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm sm:text-base resize-none text-white placeholder-gray-400"
